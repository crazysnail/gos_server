...
var tcpLog = golog.New("CenterServerTcpService")
...
func TcpService() {
	...
	p := peer.NewGenericPeer("tcp.Acceptor", "CenterServerTcpService", tcpAddr, queue)
	...
	proc.BindProcessorHandler(p, "tcp.ltv", func(ev cellnet.Event) {
		...
		case *cellnet.SessionAccepted:
			tcpLog.Debugln("CenterServerTcpService accepted")
		// 有连接断开
		case *cellnet.SessionClosed:
			tcpLog.Debugln("CenterServerTcpService session closed: ", ev.Session().ID())
		// 收到某个连接的ChatREQ消息
		case *proto.ChatREQ:
